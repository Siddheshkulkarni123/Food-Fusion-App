...
public class MyAdapter extends RecyclerView.Adapter<FoodViewHolder>{
    ...
    public void onBindViewHolder(@NonNull FoodViewHolder holder, int position) {
        ...
        holder.mDescription.setText(myFoodList.get(position).getItemDiscription());
        ...
        holder.mCardView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.putExtra("Image",myFoodList.get(holder.getAdapterPosition()).getItemImage());
                i.putExtra("Description",myFoodList.get(holder.getAdapterPosition()).getItemDiscription());
